  ...
  tools: [
    {
      name: 'reply',
      description:
        'Send a message back to a Feishu chat. Supports plain text. ' +
        'Call this for every outbound response; the tag gives you the chat_id.',
      inputSchema: {
        type: 'object',
        properties: {
          chat_id: {
            type: 'string',
            description: 'The Feishu chat_id from the inbound <channel> tag.',
          },
          text: {
            type: 'string',
